...
MERGE INTO USUARIOS u USING (SELECT 'admin' AS N, '$2a$12$JFr0ThkyUGEQ5GYmLx3Da.sezBio0./v.mUv5idiMTFROSq3Bn9bq' as P, 1 as R FROM DUAL) src ON (u.NOMBRE_USUARIO = src.N) WHEN NOT MATCHED THEN INSERT (NOMBRE_USUARIO, PASSWORD_HASH, ID_ROL) VALUES (src.N, src.P, src.R);
MERGE INTO USUARIOS u USING (SELECT 'cpt.jones' AS N, '$2a$12$GK5avUfHo6Dc9ddxSOeYcOIT8DU7WkKr4zj.csGrLz5lD.KwyHVn2' as P, 2 as R FROM DUAL) src ON (u.NOMBRE_USUARIO = src.N) WHEN NOT MATCHED THEN INSERT (NOMBRE_USUARIO, PASSWORD_HASH, ID_ROL) VALUES (src.N, src.P, src.R);
